...
public:
  ...
  virtual void train(const Dataset &filenames, const string COLOR_MODE="COLOR") = 0;

  // Classify a single image.
  virtual string classify(const string &filename, const string COLOR_MODE="COLOR") = 0;
